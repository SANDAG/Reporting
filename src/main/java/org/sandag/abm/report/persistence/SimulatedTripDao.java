        ...
        extends BaseDao<SimulatedTrip, SimulatedTripId>
{
    ...
    public ModeShare getResidentModeShare(Short scenarioId)
    {
        ...
        for (Object[] record : list)
        {
            // [0] = Total Trips
            // [1] = Mode
            if (Arrays.asList((byte)1, (byte)2).contains(record[1])) // Drive Alone
            {
                modeShare.addDriveAloneTrips((Long) record[0]);
            } else if (Arrays.asList((byte)3, (byte)4, (byte)5, (byte)6, (byte)7, (byte)8).contains(record[1])) // Carpool
            {
            ...
            } else if (Arrays.asList((byte)11, (byte)12, (byte)13, (byte)14, (byte)15, (byte)16, (byte)17, (byte)18, (byte)19, (byte)20, (byte)21, (byte)22, (byte)23, (byte)24, (byte)25)
                    .contains(record[1])) // Transit
            {
