...
CREATE TABLE abm.TRANSIT_ONOFF(
    SCENARIO_ID smallint,
    ROUTE_ID smallint,
...
CREATE TABLE abm.TRIP_MICRO_SIMUL(
    SCENARIO_ID smallint,
...
) AS SELECT * FROM CSVREAD('classpath:/org/sandag/abm/report/persistence/sql/hwy_load_sample_data.csv');

CREATE TABLE abm.HWY_TCAD(
    SCENARIO_ID smallint,
    HWYCOV_ID int,
    TOD_ID tinyint,
    AB bit,
